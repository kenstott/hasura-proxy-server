...
export type ValueTypes = string | number | boolean | null | undefined | ValueTypes[]
/**
 ...
 */
export const getDirectiveArgs = (directive?: DirectiveNode, defaults: Record<string, ValueTypes> = {}): Record<string, ValueTypes | undefined> => {
